...
extern BufferClass* mutexBufferA; // global buff0r
extern BufferClass* mutexBufferV; // global buff0r
...
public:
	...
	unsigned short getLocalPort();
        ...
        void setRecvBuffer(BufferClass* thabuffy);
...
private:
	...
	bool initializedSender;
        void cutRTPheader(unsigned char* data,unsigned length);
